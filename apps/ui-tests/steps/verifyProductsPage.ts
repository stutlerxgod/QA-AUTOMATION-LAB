...
When('I click View Product of the first product', async function (this: CustomWorld) {
...
Then('the product details should be visible', async function (this: CustomWorld) {
