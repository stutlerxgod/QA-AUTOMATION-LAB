...
Then('I should see RECOMMENDED ITEMS', async function () {
...
When('I add the first recommended item to cart', async function () {
...
Then('the recommended product should be displayed in cart', async function () {
